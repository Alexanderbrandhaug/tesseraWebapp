...
public @ResponseBody String createPost(@RequestParam String title, String description, String contactPoint, String location, String postType, String eventType, int price, String username) {
