 ...
 * @BeforeEach
 * public void setup() {
 * validator = new Validations(); // need to use setters in tests, i.e setTitle,
 * setDescription etc
 * // verdier for Post-objektet
 * Integer postId = 369;
 * String title = "Selger the Strokes-biletter!! (BILLIG)";
 * String description =
 * "biletter til Strokes konserten kommende fredag. Røverkjøp!";
 ...
 * 
 * // User-objekt
 * user = new User(userId, "kulegutten99", "glad i konserter",
 * LocalDate.now().minusDays(50), "img.jpg", false, "passord123", false, null,
 * null);
 * 
 * // post-objekt
 * post = new Post(postId, title, description, contactPoint, location, postType,
 * eventType, price, showPost, creationDate, userId, userId, user, null,null);
 * 
 * emptyPost = new Post();
 * 
